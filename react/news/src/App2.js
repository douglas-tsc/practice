...
class App extends Component {
  ...
  onSearchSubmit (event) {
    ...
    if (this.needsToSearchTopstories(query)) {
      this.fetchSearchTopstories(query, PARAM_PAGE);
    }
  ...
  render () {
    ...
    const page = (results && results[query] && results[searchKey].page) || 0;
    const list = (results && results[query] && results[searchKey].hits) || [];
    return (
      <div className='page'>
...
const Search = ({ value, onChange, onSubmit, children }) => <form>
